...
(let ((base00 (if window-system "#22202a" 'unspecified))
  ...
  (let ((success-color "#93C763")
    ...
    (custom-theme-set-faces
     ...
     ;; Border above frames
     `(header-line ((t (:background ,base00 :height 100))))

     ;; The Border around the edge of the frame
     `(fringe ((t (:background unspecified :foreground "#282828" :height 120))))
     `(vertical-border ((t (:foreground "#292938"))))
     ...
     `(web-mode-html-tag-face ((t (:foreground ,type-face ))))
     ...
     `(js2-object-property ((t (:foreground ,variable-color))))

     `(rjsx-tag ((t :foreground ,base05)))
     `(rjsx-attr ((t :foreground ,base08)))
     ...
     `(alchemist-test--success-face ((t (:foreground ,success-color :background unspecified))))
     `(alchemist-test--failed-face ((t (:foreground ,error-color :background unspecified))))

     `(term-color-black ((t (:foreground ,base08))))
     `(term-color-blue ((t (:foreground ,base05))))
     `(term-color-cyan ((t (:foreground ,base05))))
     `(term-color-green ((t (:foreground ,success-color))))
     `(term-color-magenta ((t (:foreground ,base06))))
     `(term-color-red ((t (:foreground ,error-color))))
     `(term-color-white ((t (:foreground ,text-color))))
     `(term-color-yellow ((t (:foreground ,base07))))
     )))
